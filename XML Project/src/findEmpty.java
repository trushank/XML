...
public class findEmpty {
    ...
    public static void main(String[] args) throws Exception {
        ...
        XPathExpression expression = xpath.compile("//lot/wing[string(@name)=\"2\"]/floor/slot[@type=\"Car\" and string(@vacant)=\"Yes\"]/number/@value");
        Node slotnumber = (Node) expression.evaluate(document, XPathConstants.NODE);
       expression = xpath.compile("//lot/wing[string(@name)=\"2\"]/floor/slot[@type=\"Car\" and string(@vacant)=\"Yes\"]");
